...
const BACKGROUND_BURGER_JOINT := "placeholder.png"
const BACKGROUND_CITY_STREETS_NIGHT := "placeholder.png"
const BACKGROUND_FETISH_CLUB := "placeholder.png"
...
const MUSIC_DATE := "Paradise_Found.mp3"
const MUSIC_FETISH_CLUB := "Paradise_Found.mp3"
const MUSIC_OFFICE := "Paradise_Found.mp3"
const MUSIC_OPENING_SCENE := "Paradise_Found.mp3"
const MUSIC_MAIN_MENU := "Paradise_Found.mp3"
const MUSIC_WAKE_UP := "Paradise_Found.mp3"
